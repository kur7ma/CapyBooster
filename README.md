...
Each of the 117 tweak cards names what you pay for the tweak, not only what you
get.
...
-- CapyBooster - Windows optimization wizard
   CapyBooster v4.4.5   built 2026-08-26   commit b16f70c
...
The report lists 20 techniques the pack leaves alone. A sample:
...
all 117 tweak cards are translated. Verbose output inside individual modules
